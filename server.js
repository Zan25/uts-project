...
const client = new Client({
    connectionString: 'postgres://ticker_order_user:DX6mgTvJCqqtSfrqFz7tHBNls1RgHMwy@dpg-con0p7q1hbls73fak2r0-a.singapore-postgres.render.com/ticker_order',
    ssl: {
...
app.post('/order', async (req, res) => {
    try {
        ...
        const queryInsert = 'INSERT INTO orders (customer_name, email, phone_number, order_type, order_date) VALUES ($1, $2, $3, $4, $5)';
